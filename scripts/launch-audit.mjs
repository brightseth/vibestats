  ...
  const paths = [
    {
      ...
      expectedType: 'text/html',
      allowStatuses: [200],
      mustInclude: ['What kind of coder are you? Claude Code already knows.', '<code>/insights</code>', 'Copy npx reveal command', 'install-claude-command', 'Try the reveal demo', 'shouldAutoRunDemo()', 'No file hunting', 'Explore sample pairings without data', '/compare?a=orchestrator&b=shipper'],
