...
async function assertRoutes() {
  ...
  assert(genomeHtml.includes('What are you?') && genomeHtml.includes('data-copy-command="/insights"') && genomeHtml.includes('Copy npx reveal command') && genomeHtml.includes('Copy claim command') && genomeHtml.includes('data-copy-command="npx --yes github:brightseth/vibestats#feat/wave-1-identity"') && genomeHtml.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal') && genomeHtml.includes('install-claude-command') && genomeHtml.includes('Raw Claude Code /insights data stays local'), 'genome page should convert community curiosity into reveal-first onboarding with claim and Claude Code install hooks');
