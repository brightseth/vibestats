...
async function assertRoutes() {
  ...
  assert(launchDoc.includes('Hard launch gate: rotate any credential') && launchDoc.includes('npm run reveal:delete -- <reveal-slug>'), 'launch checklist should treat secret rotation as a hard gate and document anonymous reveal takedown');
