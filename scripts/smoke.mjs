...
async function assertRoutes() {
  ...
  assert(browseHtml.includes('class="reveal-strip"') && browseHtml.includes('What are you?') && browseHtml.includes('data-copy-command="/insights"') && browseHtml.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal'), 'browse page should offer a direct terminal-first reveal command path even when the directory is populated');
  ...
  assert(matchHtml.includes('class="reveal-strip"') && matchHtml.includes('Find your real match') && matchHtml.includes('data-copy-command="/insights"') && matchHtml.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal'), 'match page should offer a direct terminal-first reveal command path even when matches are populated');
  ...
  assert(genomeHtml.includes('What are you?') && genomeHtml.includes('data-copy-command="/insights"') && genomeHtml.includes('Copy npx reveal command') && genomeHtml.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal') && genomeHtml.includes('Raw Claude Code /insights data stays local'), 'genome page should convert community curiosity into reveal-first onboarding');
  ...
  assert(dashboardHtml.includes('/insights') && dashboardHtml.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal'), 'static dashboard should teach share recipients the terminal-first reveal command directly');
...
async function assertWrappedShareLoop() {
  ...
  assert(wrappedHtml.includes('What are you?') && wrappedHtml.includes('/insights') && wrappedHtml.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal'), 'wrapped share page should teach recipients the terminal-first reveal command directly');
