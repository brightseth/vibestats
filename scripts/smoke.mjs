...
async function assertRoutes() {
  ...
  assert(genomeHtml.includes('What are you?') && genomeHtml.includes('data-copy-command="/insights"') && genomeHtml.includes('Copy npx reveal command') && genomeHtml.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal') && genomeHtml.includes('install-claude-command') && genomeHtml.includes('Raw Claude Code /insights data stays local'), 'genome page should convert community curiosity into reveal-first onboarding with a Claude Code install hook');
  ...
  assert(dashboardHtml.includes('/insights') && dashboardHtml.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal') && dashboardHtml.includes('install-claude-command'), 'static dashboard should teach share recipients the terminal-first reveal command and Claude Code install hook directly');
...
async function assertProfileShareLoop() {
  ...
  assert(profileHtml.includes('Claude Code has already captured your build fingerprint') && profileHtml.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal'), 'profile reveal panel should carry the terminal-first command path without sending visitors hunting');
...
async function assertShareCardCta() {
  ...
  assert(body.includes('What are you?') && body.includes('/insights') && body.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal'), 'share card should teach recipients the terminal-first reveal command without another hop');
...
async function assertWrappedShareLoop() {
  ...
  assert(wrappedHtml.includes('What are you?') && wrappedHtml.includes('/insights') && wrappedHtml.includes('npx --yes github:brightseth/vibestats#feat/wave-1-identity reveal') && wrappedHtml.includes('install-claude-command'), 'wrapped share page should teach recipients the terminal-first reveal command and Claude Code install hook directly');
