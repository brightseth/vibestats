...
async function assertRoutes() {
  ...
  assert(viralEventsHelper.includes('viral_events') && viralEventsHelper.includes('reveal_created') && viralEventsHelper.includes('reveal_view') && viralEventsHelper.includes('profile_view') && viralEventsHelper.includes('compare_started') && viralEventsHelper.includes('profile_claimed') && viralEventsHelper.includes('SOURCE_REF_RE') && !viralEventsHelper.includes('user-agent') && !viralEventsHelper.includes('x-forwarded-for'), 'viral events helper should record bounded attribution events without raw request identifiers');
  ...
  assert(launchAudit.includes("label: 'reveal homepage'") && launchAudit.includes('See an example') && launchAudit.includes('Reveal mine') && launchAudit.includes('shouldAutoRunDemo()') && launchAudit.includes('agent-insights.json'), 'launch audit should prevent homepage onboarding regressions');
