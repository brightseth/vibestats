...
If the user does not want to publish yet, keep the reveal useful: point them to the archetype-only compare link, copy-ready reveal text, X share URL, and complementary pairing preview printed by the CLI.
