...
- 2026-07-08 · dna-presence-wire STAGED (rubric only, no code) · docs/rubrics/dna-presence-wire.md · platform resolver live: /api/handles/by-github · build in fresh session through verifier loop + codex
